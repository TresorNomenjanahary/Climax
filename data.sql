...
CREATE VIEW article_v AS SELECT article.*, region.nom FROM Article join region on region.id = article.intitule ;

INSERT INTO Article VALUES(3,'L’Arctique au bord de la rupture','D’un point de vue moins global, du côté de l’Arctique, la situation semble déjà prête à basculer. Depuis le début des années 2000, l’inlandsis du Groenland perd inexorablement de sa glace. Essentiellement sous l’effet de la hausse des températures de l’air. Et cette glace n’est désormais plus régénérée par les chutes de neige. Avant 2050, la région devrait connaître des étés libres de glace. Les scientifiques ont placé le curseur du point de non-retour quelque part entre +1,5 °C et +3 °C. L’effondrement de la calotte aurait beau prendre des siècles, il deviendrait ce que les chercheurs qualifient d’irréversible. Le seul moyen de revenir en arrière serait alors de rafraîchir notre planète bien en dessous de ces températures.','2022-05-10','groen.jpg');
